(function($) {
  ...
  var ikSlider = function(el, options) {
    ...
    function _triggerChange() {
	  ...
	  if (typeof removeCrest === "function" && scrwidth > 760) { 
		  if(current == 1){
			$('#crest-container').addClass('wow fadeOutLeft animated');
			$('.anim-from-right').removeClass('wow fadeInRight animated');
			$('.anim-from-left').removeClass('wow fadeInLeft animated');
			$('.anim-from-left').css('animation-name', '');
			$('.anim-from-right').css('animation-name', '');
		  }
		  else if(current == 0){
			  $('#crest-container').removeClass('wow fadeOutLeft animated');
			  $('.anim-from-right').addClass('wow fadeInRight animated');
			  $('.anim-from-left').addClass('wow fadeInLeft animated');
			  console.log('Most kéne visszajönni');
		  }
	  }
